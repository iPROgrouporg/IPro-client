                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full">
                                {vacancy.slice(0, visibleJobs).map((job, index) => (
                                    <motion.div
                                        ...
                                        className={`relative overflow-hidden bg-blue-400/10 backdrop-blur-lg border border-blue-500/20 text-white p-6 rounded-2xl shadow-md transition-all duration-300 group ${job.active
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-center mt-6 z-10 relative">
                                            <motion.button
                                                whileHover={job.active ? { scale: 1.05 } : {}}
                                                disabled={!job.active}
                                                className={`px-6 py-2 font-bold rounded-md transition-all duration-300 ${job.active
