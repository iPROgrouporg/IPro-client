...
const PrimaryService = ({StarsLeftImg, t}) => {
    ...
    const getRandomService = async () => {
        try {
            ...
            const randomServices = shuffled.slice(0, 6)
            setService(randomServices)
            ...
            <div className="container mx-auto mb-10 max-w-[1300px]">
                ...
                <div className="mt-12 px-2">
                    ...
                    <div className="hidden md:flex justify-center items-stretch gap-6">
                        {service.map((item, index) => (
                            <motion.div
                                ...
                                onClick={()=>navigate(`/services-info/${item.id}`)}
                            >
                                <img
                                ...
                                />
                                <div
                                    className="absolute inset-0 flex items-end justify-center bg-gradient-to-t from-black/70 to-transparent p-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    ...
                    <div className="md:hidden grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {service.map((item, index) => (
                            ...
                            >
                                ...
                                />
                                <div
                                    className="absolute inset-0 flex items-end justify-center bg-gradient-to-t from-black/80 to-transparent p-4">
                   ...
                   <div className="flex justify-center mt-5">
                        <button className="text-white  text-sm font-bold px-6 py-3 rounded-full bg-blue-500 hover:bg-blue-600 transition-all duration-300 hover:scale-105 shadow-lg" onClick={()=>navigate("/services")}>
                            {t("learnMore")}
                        </button>
                    </div>
                </div>
