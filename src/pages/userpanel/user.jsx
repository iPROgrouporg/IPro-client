...
import { FaCamera, FaClipboardList, FaShoppingCart, FaUserCircle } from "react-icons/fa";
...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-screen text-white">
      {/* Sidebar */}
      <div
        className={`fixed z-50 md:static top-0 left-0 h-full bg-[#292d32] w-72 p-6 transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
          }`}
      >
        <NavLink to={"/"}>
